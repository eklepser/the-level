...
public class LevelCollisionManager {
    ...
    public LevelCollisionManager(com.eklepser.thelevel.logic.game.level.Level level) {
        this.level = level;
    ...
    public void updateLevel(com.eklepser.thelevel.logic.game.level.Level level) {
